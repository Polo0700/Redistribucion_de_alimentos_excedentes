...
@section('title', 'Acciones importantes eliminadas')
    ...
    <div class="flex items-center justify-between">
        ...
        <div>
            ...
            <h1 class="text-3xl font-bold text-gray-900">
                Acciones importantes eliminadas
            </h1>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('acciones.restore', $accion->id_accion) }}" method="POST"
                                  onsubmit="return confirm('¿Restaurar esta acción importante? Volverá a mostrarse en el listado principal.')">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                            ...
                            <form action="{{ route('acciones.forceDestroy', $accion->id_accion) }}" method="POST"
            ...
            @empty
                ...
                <tr>
                    <td colspan="5" class="px-6 py-10 text-center text-gray-400">
                        No hay acciones importantes eliminadas.
                    </td>
                </tr>
