...
@section('title', 'Entregas eliminadas')
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('entregas.restore', $entrega->id_entrega) }}" method="POST"
                                  onsubmit="return confirm('¿Restaurar esta entrega? Volverá a mostrarse en el listado principal.')">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                            ...
                            <form action="{{ route('entregas.forceDestroy', $entrega->id_entrega) }}" method="POST"
