                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('carritos.show', $carrito->id_carrito) }}"
                               class="px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-100 rounded-lg">
                                Ver
                            </a>

                           <a href="{{ route('carritos.edit', $carrito->id_carrito) }}"
                            ...
                            <form action="{{ route('carritos.destroy', $carrito->id_carrito) }}" method="POST"
                                  onsubmit="return confirm('¿Eliminar este carrito? Se puede restaurar después.')">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
