...
@section('title', 'Carritos eliminados')
            ...
            @forelse($carritos as $carrito)
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-900">
                        {{ $carrito->usuario->nombre ?? 'Sin usuario' }} {{ $carrito->usuario->apellido ?? '' }}
                    </td>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('carritos.restore', $carrito->id_carrito) }}" method="POST"
                                  onsubmit="return confirm('¿Restaurar este carrito? Volverá a mostrarse en el listado principal.')">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                            ...
                            <form action="{{ route('carritos.forceDestroy', $carrito->id_carrito) }}" method="POST"
