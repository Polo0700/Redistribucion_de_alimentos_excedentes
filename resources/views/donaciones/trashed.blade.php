            ...
            @forelse($donaciones as $donacion)
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-900">
                        {{ $donacion->usuario->nombre ?? 'Sin usuario' }} {{ $donacion->usuario->apellido ?? '' }}
                    </td>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('donaciones.restore', $donacion->id_donacion) }}" method="POST"
                                  onsubmit="return confirm('¿Restaurar esta donación? Volverá a mostrarse en el listado principal.')">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                            ...
                            <form action="{{ route('donaciones.forceDestroy', $donacion->id_donacion) }}" method="POST"
