...
@section('title', 'Listas de deseos eliminadas')
            ...
            @forelse($listas as $lista)
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-900">
                        {{ $lista->usuario->nombre ?? 'Sin usuario' }} {{ $lista->usuario->apellido ?? '' }}
                    </td>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('listas-deseos.restore', $lista->id_lista) }}" method="POST"
                                  onsubmit="return confirm('¿Restaurar esta lista de deseos? Volverá a mostrarse en el listado principal.')">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                            ...
                            <form action="{{ route('listas-deseos.forceDestroy', $lista->id_lista) }}" method="POST"
            ...
            @empty
                ...
                <tr>
                    <td colspan="5" class="px-6 py-10 text-center text-gray-400">
                        No hay listas de deseos eliminadas.
                    </td>
                </tr>
